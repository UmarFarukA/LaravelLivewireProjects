    ...
    <aside id="sidebar" class="bg-white border-r w-64 flex-shrink-0 hidden md:block">
      ...
      <nav class="p-4">
        ...
        <ul class="space-y-2">
          ...
          <li>
            <a href="#my-orders" class="flex items-center p-2 rounded-md hover:bg-gray-100">
      ...
      <header class="bg-white border-b p-4 hidden md:flex items-center justify-between">
        ...
        <div class="flex items-center">
          <div class="relative mr-4">
            <input type="text" placeholder="Search products..." class="pl-8 pr-4 py-2 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-sky-500">
