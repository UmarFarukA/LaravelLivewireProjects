...
$user_id = !Session::has("user") ? false : Session::get("user")["id"];

// dd($user_id);

?>

<section class="container mx-auto p-4 mt-4 bg-blue-500">
  <?php loadPatials("message"); ?>
  <div class="rounded-lg shadow-md bg-white p-3">
    <div class="flex justify-between items-center">
      ...
      <?php if (Authorization::authorize($listing["user_id"] === $user_id)): ?>
...
<section class="container mx-auto p-4">
  ...
  <a href="<?= $listing['email'] ?>"
    class="block w-full text-center mt-4 px-5 py-2.5 shadow-sm rounded border text-base font-medium cursor-pointer text-indigo-700 bg-indigo-100 hover:bg-indigo-200">
    Apply Now
  </a>
</section>
