...
<template>
    ...
    <section class="bg-gradient-to-r from-green-600 to-green-800 text-white py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">Connecting alumni, preserving heritage, and building a
                stronger community together</p>
            <div class="space-x-4">
                <a href="get-involved.html"
                    class="bg-white text-green-800 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition duration-300 inline-block">Join
                    Us Today</a>
                <Link :href="route('about')"
                    class="border-2 border-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-green-800 transition duration-300 inline-block">Learn
                    More
                </Link>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-gray-50 rounded-lg p-6 shadow-md">
                    ...
                    <p class="text-gray-600 mb-4">Join us for our biggest gathering of the year with networking, dinner,
                        and entertainment.</p>
                ...
                <div class="bg-gray-50 rounded-lg p-6 shadow-md">
                    ...
                    <p class="text-gray-600 mb-4">Professional development session focusing on leadership and career
                        advancement.</p>
                    <a href="events.html" class="text-green-600 font-semibold hover:text-green-800">Learn More →</a>
                </div>
                <div class="bg-gray-50 rounded-lg p-6 shadow-md">
                    ...
                    <p class="text-gray-600 mb-4">Give back to the community through various volunteer activities and
                        initiatives.</p>
                    <a href="events.html" class="text-green-600 font-semibold hover:text-green-800">Learn More →</a>
                </div>
            </div>
            <div class="text-center mt-8">
                <a href="events.html"
                    class="bg-green-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-green-700 transition duration-300 inline-block">View
                    All Events</a>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 lg:grid-cols-3 gap-8">
                ...
                <div class="text-center">
                    ...
                    <p class="text-gray-600">Participate in community service and make a positive difference together.
                    </p>
                </div>
            </div>
            <div class="text-center mt-8">
                <a href="get-involved.html"
                    class="bg-green-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-green-700 transition duration-300 inline-block">Join
                    Our Community</a>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-16">
                ...
                <div class="grid md:grid-cols-2 gap-8 items-center">
                    <div>
                        <p class="text-gray-600 mb-4">Founded in 2004, Alhudahuda (ALCOZA04) has been a cornerstone of
                            alumni engagement and community building for over two decades. What started as a small group
                            of passionate graduates has grown into a thriving association with hundreds of active
                            members worldwide.</p>
                        <p class="text-gray-600">Our association has consistently fostered connections, supported
                            professional development, and maintained the rich traditions that define our community.</p>
                    </div>
            ...
            <div class="mb-16">
                <div class="grid md:grid-cols-2 gap-8">
                    <div class="bg-green-50 p-8 rounded-lg">
                        ...
                        <p class="text-gray-700">To strengthen the bonds among alumni through meaningful connections,
                            professional development opportunities, and community service initiatives that honor our
                            shared heritage and values.</p>
                    </div>
                    <div class="bg-emerald-50 p-8 rounded-lg">
                        <h3 class="text-2xl font-bold mb-4 text-emerald-900">Our Vision</h3>
                        <p class="text-gray-700">To be the premier alumni association that empowers members to achieve
                            personal and professional excellence while contributing positively to society and preserving
                            our legacy for future generations.</p>
                    </div>
                </div>
            </div>
    ...
    <section id="alumni" class="py-16 bg-green-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-16">
                ...
                <UserCard
                    user-name="Dr Garzali Aminu"
                    title="Chief Medical Officer"
                    description="Leading healthcare innovation and serving communities worldwide through medical excellence and research."
                />
                <UserCard
                    user-name="Ibrahim Idris"
                    title="Entrepreneur"
                    description="Founded multiple successful businesses and mentors young entrepreneurs in the Financial industry."
                />

                <UserCard
                    user-name="Dr Abubakar Nuhu"
                    title="Chief Vetenary Officer"
                    description="Leading healthcare innovation and serving communities worldwide through medical excellence and research."
                />
            </div>
            </div>
            ...
            <div>
                ...
                <div class="bg-gray-50 rounded-lg p-6">
                    <div class="mb-4">
                        <input type="text" placeholder="Search alumni by name, profession, or location..."
   ...
   <!-- Get Involved Section -->
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-green-50 rounded-lg p-8 text-center">
                    ...
                    <p class="text-gray-600 mb-6">Join our growing community of alumni and enjoy exclusive benefits,
                        networking opportunities, and lifelong connections.</p>
                    ...
                    <button
                        class="bg-green-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-green-700 transition duration-300">Join
                        Now</button>
                </div>
                ...
                <div class="bg-emerald-50 rounded-lg p-8 text-center">
                    ...
                    <p class="text-gray-600 mb-6">Share your skills and time to help organize events, mentor students,
                        and contribute to our community initiatives.</p>
                    <div class="space-y-3 mb-6">
                    ...
                    <button
                        class="bg-emerald-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-emerald-700 transition duration-300">Volunteer</button>
                </div>
                ...
                <div class="bg-teal-50 rounded-lg p-8 text-center">
                    ...
                    <p class="text-gray-600 mb-6">Support our initiatives, scholarship programs, and community projects
                        that make a lasting impact on current and future generations.</p>
                    <div class="space-y-3 mb-6">
                    ...
                    <button
                        class="bg-teal-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-teal-700 transition duration-300">Donate</button>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid md:grid-cols-2 gap-12">
                <div>
                    ...
                    <div class="space-y-8">
                        <div class="flex items-start space-x-4">
                            <div
                                class="bg-green-600 w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0">
                            ...
                            <div>
                                <h3 class="font-semibold text-gray-900 mb-2">Our Address</h3>
                                <p class="text-gray-600">123 Alumni Street<br>Community Center, Building A<br>City,
                                    State 12345<br>United States</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                <h3 class="font-semibold text-gray-900 mb-2">Email Addresses</h3>
                                <div class="space-y-1">
                                    <p class="text-gray-600">General Inquiries: <a href="mailto:info@alcoza04.org"
                                            class="text-green-600 hover:text-green-800">info@alcoza04.org</a></p>
                                    <p class="text-gray-600">President: <a href="mailto:president@alcoza04.org"
                                            class="text-green-600 hover:text-green-800">president@alcoza04.org</a></p>
                                    <p class="text-gray-600">Events: <a href="mailto:events@alcoza04.org"
                                            class="text-green-600 hover:text-green-800">events@alcoza04.org</a></p>
                                    <p class="text-gray-600">Membership: <a href="mailto:membership@alcoza04.org"
                                            class="text-green-600 hover:text-green-800">membership@alcoza04.org</a></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                <h3 class="font-semibold text-gray-900 mb-2">Phone Numbers</h3>
                                <div class="space-y-1">
                                    <p class="text-gray-600">Main Office: <a href="tel:+15551234567"
                                            class="text-green-600 hover:text-green-800">+1 (555) 123-4567</a></p>
                                    <p class="text-gray-600">Events Hotline: <a href="tel:+15559876543"
                                            class="text-green-600 hover:text-green-800">+1 (555) 987-6543</a></p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mt-12">
                        ...
                        <div class="flex space-x-4">
                            <a href="#"
                                class="bg-green-600 w-12 h-12 rounded-full flex items-center justify-center text-white hover:bg-green-700 transition duration-300">
                            ...
                            <a href="#"
                                class="bg-green-500 w-12 h-12 rounded-full flex items-center justify-center text-white hover:bg-green-600 transition duration-300">
                            ...
                            <a href="#"
                                class="bg-green-700 w-12 h-12 rounded-full flex items-center justify-center text-white hover:bg-green-800 transition duration-300">
                            ...
                            <a href="#"
                                class="bg-green-400 w-12 h-12 rounded-full flex items-center justify-center text-white hover:bg-green-500 transition duration-300">
                ...
                <div>
                    ...
                    <form class="space-y-6">
                        ...
                        <div>
                            <FormInput label="Phone" type="number" />
                        </div>
                        ...
                        <button type="submit"
                            class="w-full bg-green-600 text-white py-3 px-6 rounded-lg font-semibold hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition duration-300">
                            Send Message
                        </button>

                        <p class="text-sm text-gray-500 text-center">We'll get back to you within 24-48 hours during
                            business days.</p>
                    </form>
                </div>
            </div>
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mt-8">
                <button
                    class="bg-green-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-green-700 transition duration-300">View
                    All Photos</button>
            </div>
        </div>
    </section>
