<aside id="sidebar"
    class="bg-green-700 text-gray-200 w-64 fixed h-full transform -translate-x-full md:translate-x-0 transition-transform duration-300 z-40">
    <div class="p-4 text-center text-lg font-bold border-b border-green-800">
    ...
    <nav class="p-4 space-y-4 md:pt-8">
        @auth
            ...
            <x-nav-link href="{{ route('sessions.index') }}" class="flex gap-1 items-center">
                <svg class="w-6 h-6 text-white hover:text-green-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                    width="24" height="24" fill="none" viewBox="0 0 24 24">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <x-nav-link href="{{ route('settings.index') }}" class="flex gap-1 items-center">
                <svg class="w-6 h-6 text-white hover:text-green-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                    width="24" height="24" fill="none" viewBox="0 0 24 24">
                    <path stroke="currentColor" stroke-linecap="square" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="{{ route('logout') }}"
                class="mt-6 flex items-center gap-2 rounded-md p-2 bg-slate-50 hover:bg-slate-100 text-green-700 hover:text-green-800 justify-center cursor-pointer">
