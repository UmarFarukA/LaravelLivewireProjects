...
<div class="sidebar d-flex flex-column" id="navbarNav">
    <div class="text-center pt-3 mb-3">
        <img src="./images/kasu_logo.jpeg" alt="KASU" class="w-50">
        <p class="text-success fs-5 pt-2">Knowledge Drive Hub</p>
    </div>
    ...
    <div class="mt-1 d-none d-md-block ">
        ...
        <a href="/sessions" class="d-flex align-items-center">
    ...
    <div class="d-flex align-items-center mt-5 ms-2 text-success">
