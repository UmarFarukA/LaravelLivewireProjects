<footer id="contact" class="w-full border-t bg-white py-12 md:py-16 lg:py-20">
    <div class="container mx-auto px-4 md:px-6">
      <div class="grid gap-8 lg:grid-cols-4">
        ...
        <div class="space-y-4">
          <h3 class="text-base font-medium">Newsletter</h3>
          <p class="text-sm text-gray-500">
            Subscribe to our newsletter for the latest updates and offers.
          </p>
          <form class="space-y-2">
            <div class="flex gap-2">
              <input type="email" placeholder="Enter your email" class="w-full rounded-md border border-gray-300 px-3 py-2 text-sm" />
              <button type="submit" class="px-3 py-2 text-sm font-medium bg-sky-500 text-white rounded-md hover:bg-sky-600">
                Subscribe
              </button>
            </div>
